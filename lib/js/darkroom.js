...
;(function(window, document, fabric) {
  ...
  Darkroom.prototype = {
    ...
    _createFabricImage:function(imgElement) {
        ...
        var newFabricImage = new fabric.Image(imgElement, {
        ...
        newFabricImage.setScaleX(scale);
        newFabricImage.setScaleY(scale);

        return newFabricImage;
    },

    createFabricImage: function(imgElement) {
        this.image = this._createFabricImage(imgElement);
